(function($) {
    ...
    var myColor;
    var all_questions = [{
        question_string: "25 + 3 ? ",
        choices: {
            correct: "75",
            wrong: ["70", "65", "80"]
        }
    }, {
        question_string: "123 x 20 ? ",
        choices: {
            correct: "2460",
            wrong: ["2500", "2350", "2045"]
        }
    }, {
        question_string: "10 x 45 x 2?",
        choices: {
            correct: "900",
            wrong: ["850", "1000", "1200"]
        }
    }, {
        question_string: '23 x 2 x 78 ?',
        choices: {
            correct: "3588",
            wrong: ["3456", "4500", "4750"]
        }
    }, {
        question_string: '15 x 7 x 9 x 26 ?',
        choices: {
            correct: "24570",
            wrong: ["25500", "32500", "56705"]
        }
    }];
